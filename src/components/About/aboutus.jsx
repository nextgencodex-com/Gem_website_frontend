  ...
  return (
    <main className="bg-black min-h-screen py-20 px-4 sm:px-6 lg:px-8">
      ...
      <div className="hidden md:block">
        ...
        <div className="relative h-[500px] flex items-center justify-center text-center overflow-hidden bg-black -mt-20 mb-16">
          <img
            src="/images/Ab.webp"
          ...
          <div className="relative z-20 space-y-6 px-12 max-w-4xl mx-auto">
            <h1 className="font-serif text-6xl text-white font-bold mb-4 relative">
              About Us
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          {/* Section 2: What We Offer - Desktop */}
          <section className="grid md:grid-cols-2 gap-12 items-center mb-28">
          ...
          {/* Section 4: Why Choose Us - Desktop */}
          <section className="grid md:grid-cols-2 gap-12 items-center mb-28">
      ...
      <div className="block md:hidden">
        {/* Hero Section - Mobile */}
        <div className="relative h-[400px] flex items-center justify-center text-center overflow-hidden bg-black -mt-20 mb-12">
          <img
            src="/images/Ab.webp"
            alt="Luxury Gemstones About Us"
            className="absolute inset-0 w-full h-full object-cover z-0"
          />
          <div className="absolute inset-0 bg-black/50 z-10" />
          <div className="relative z-20 space-y-4 px-6 max-w-4xl mx-auto">
            <h1 className="font-serif text-4xl text-white font-bold mb-4 relative">
              About Us
        ...
        <div className="max-w-7xl mx-auto relative px-4">
          ...
          <section className="flex flex-col gap-8 mb-16">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-400 leading-relaxed text-base">
                ...
                for creating exquisite jewelry that tells a story. What started as a small 
                family workshop has blossomed into a destination for those who appreciate 
                fine craftsmanship and timeless design.
              </p>
              <div className="flex flex-wrap gap-3 pt-2">
                {['1985', 'Tradition', 'Excellence'].map((item, i) => (
                  <div key={i} className="px-3 py-1.5 bg-white/10 rounded-lg border border-white/20 text-gray-300 text-xs">
                    {item}
                  </div>
                ))}
              </div>
          ...
          {/* Section 2: What We Offer - Mobile */}
          <section className="flex flex-col gap-8 mb-16">
            <div className="relative h-[300px] rounded-2xl overflow-hidden shadow-xl">
              <img
                src="/images/i2.jpg"
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-2">
                  ...
                  <span className="text-gray-400 text-sm">
                    <span className="font-semibold text-white">Fine Jewelry:</span> Exquisite diamonds and gemstones
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-white/60 text-lg">✦</span>
                  <span className="text-gray-400 text-sm">
                    <span className="font-semibold text-white">Wedding Collections:</span> Timeless engagement rings
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-white/60 text-lg">✦</span>
                  <span className="text-gray-400 text-sm">
                    <span className="font-semibold text-white">Custom Design:</span> Bring your vision to life
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-white/60 text-lg">✦</span>
                  <span className="text-gray-400 text-sm">
                    <span className="font-semibold text-white">Vintage Revival:</span> Restored heirloom pieces
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-white/60 text-lg">✦</span>
                  <span className="text-gray-400 text-sm">
                    <span className="font-semibold text-white">Everyday Elegance:</span> Minimalist designs
                  </span>
                </li>
              </ul>
            </div>
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 gap-6">
              ...
              <div className="group flex items-start gap-4 text-left">
                ...
                <div>
                  <h3 className="font-serif text-base text-white font-bold mb-1">
                    Premium Quality Material
                  </h3>
          ...
          {/* Section 4: Why Choose Us - Mobile */}
          <section className="flex flex-col gap-8 mb-16">
            <div className="relative h-[300px] rounded-2xl overflow-hidden shadow-xl">
              <img
                src="/images/i3.jpg"
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3 p-3 bg-white/5 rounded-xl border border-white/10">
                  <span className="text-white/60 text-lg">✦</span>
                  <div>
                    <h4 className="font-semibold text-white text-sm mb-1">Heritage Craftsmanship</h4>
                    <p className="text-gray-400 text-xs">Three generations of master artisans</p>
                  </div>
                </li>
                <li className="flex items-start gap-3 p-3 bg-white/5 rounded-xl border border-white/10">
                  <span className="text-white/60 text-lg">✦</span>
                  <div>
                    <h4 className="font-semibold text-white text-sm mb-1">Certified Authentic</h4>
                    <p className="text-gray-400 text-xs">All diamonds IGI/HRD certified</p>
                  </div>
                </li>
                <li className="flex items-start gap-3 p-3 bg-white/5 rounded-xl border border-white/10">
                  <span className="text-white/60 text-lg">✦</span>
                  <div>
                    <h4 className="font-semibold text-white text-sm mb-1">Lifetime Service</h4>
                    <p className="text-gray-400 text-xs">Free cleaning, polishing, inspections</p>
                  </div>
                </li>
                <li className="flex items-start gap-3 p-3 bg-white/5 rounded-xl border border-white/10">
                  <span className="text-white/60 text-lg">✦</span>
                  <div>
                    <h4 className="font-semibold text-white text-sm mb-1">Secure Shopping</h4>
                    <p className="text-gray-400 text-xs">100% insured shipping, easy returns</p>
                  </div>
                </li>
                <li className="flex items-start gap-3 p-3 bg-white/5 rounded-xl border border-white/10">
                  <span className="text-white/60 text-lg">✦</span>
                  <div>
                    <h4 className="font-semibold text-white text-sm mb-1">Personalized Service</h4>
                    <p className="text-gray-400 text-xs">Dedicated consultant for every client</p>
                  </div>
                </li>
              </ul>
            </div>
