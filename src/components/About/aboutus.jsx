...
const AboutUs = () => {
  const certifications = [
    {
      id: 1,
      image: "/images/diamond.gif", // updated to gif path
    ...
    {
      id: 3,
      image: "/images/privacy-policy.gif",
    ...
    <div className="bg-gray-50 min-h-screen font-[Poppins]">
      ...
      <div className="relative h-[400px] md:h-[500px] flex items-center justify-center text-center text-white overflow-hidden">
        ...
        <div className="relative z-20 space-y-4 px-6 lg:px-12 max-w-3xl mx-auto">
          <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold drop-shadow-lg mb-2">About Us</h1>
          <h2 className="text-lg md:text-xl font-semibold">Three Generations Of Gem Excellence</h2>
        </div>
      </div>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto">
          ...
          <div className="max-w-6xl mx-auto space-y-12">
            ...
            {/* Companies Card */}
            <div className="bg-[#f8f4ed] rounded-2xl text-black p-8 md:p-12">
            ...
            {timelineItems.map((item, index) => (
              ...
              >
                ...
                <div className="flex-shrink-0 mb-6 md:mb-0">
                  <div className="w-32 h-32 bg-[#bf9b30] rounded-full flex items-center justify-center text-white font-bold text-2xl shadow-lg">
                    {item.year}
                  </div>
                </div>
      ...
      <section className="py-16 px-4 bg-[#f8f4ed] text-black">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-5xl text-[#bf9b30] font-bold mb-4">
              Our Vision & Mission
            </h2>
            <div className="w-24 h-1 bg-[#00B9B3] mx-auto rounded-full"></div>
          </div>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-5xl font-bold text-[#bf9b30] mb-4">
              Meet Our Founder
            </h2>
            <div className="w-24 h-1 bg-[#00B9B3]  mx-auto rounded-full"></div>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 lg:order-2">
                <div className="bg-gray-50 rounded-2xl p-8 shadow-lg">
                  ...
                  <p className="text-lg text-black italic mb-6 text-center">
      ...
      <section className="py-16 px-4 bg-[#f8f4ed]">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold text-[#bf9b30] mb-4">
