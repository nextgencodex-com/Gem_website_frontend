                ...
                <div className="mt-8 bg-white/5 rounded-xl p-6 border border-white/10">
                  ...
                  <div className="space-y-3">
                    <button 
                      ...
                      className="text-sm text-gray-400 hover:text-white block transition-all duration-300 w-full text-left group"
                    >
                      Delivery & Returns
                      <span className="block w-0 h-0.5 bg-white/30 group-hover:w-full transition-all duration-300"></span>
                    </button>
                    <button 
                      onClick={() => navigate("/jewellery-care")}
                      className="text-sm text-gray-400 hover:text-white block transition-all duration-300 w-full text-left group"
                    >
                    ...
                    <button 
                      onClick={() => navigate("/secure-shopping")}
                      className="text-sm text-gray-400 hover:text-white block transition-all duration-300 w-full text-left group"
                    >
                      Secure Shopping
                      <span className="block w-0 h-0.5 bg-white/30 group-hover:w-full transition-all duration-300"></span>
