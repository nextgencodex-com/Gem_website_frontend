...
function HeroSection({ navigate }) {
  ...
  return (
    <div className="relative h-[400px] md:h-[700px] flex items-center justify-center text-center text-white overflow-hidden font-poppins rounded-[3rem] md:rounded-[4rem] mx-4 md:mx-8 mt-4 md:mt-6">
      <video
        ref={videoRef}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex justify-center mb-8 md:mb-10">
            <div className="max-w-md w-full text-center">
              ...
              <h3 className="text-lg md:text-xl font-bold text-[#bf9b30] mb-2">
                Most Popular Items
              </h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 gap-6 md:gap-8">
            {categoryItems.map((item, index) => (
              ...
              >
                ...
                {/* Title Below Image */}
                <h3 className="text-base md:text-lg font-bold text-gray-800 mt-4 group-hover:text-[#bf9b30] transition-colors duration-300">
                  {item.title}
                </h3>
              </div>
            ))}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 md:gap-10">
            {giftingServices.map((item, index) => (
              ...
              >
                ...
                {/* Title Below Image */}
                <h3 className="text-lg md:text-xl font-bold text-gray-800 mb-2 group-hover:text-[#bf9b30] transition-colors duration-300">
                  {item.title}
                </h3>
                ...
                <button 
                  ...
                  className="text-[#00B9B3] hover:text-[#009690] font-medium text-sm md:text-base transition-colors duration-300 flex items-center gap-1"
                >
